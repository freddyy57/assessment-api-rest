...
const clientsController = async (req = request, res = response) => {
  ...
  try {
    ...
    return res.status(500).json({
      msg: 'An error has occurred, please contact your administartor3'
    });
  }
};
...
const clientsDetail = async (req = request, res = response) => {
  ...
  try {
    ...
    return res.status(500).json({
      msg: 'An error has occurred, please contact your administartor1'
    });
  }
};
...
const policiesClientsDetail = async (req = request, res = response) => {
  ...
  return res.status(204).json({
    msg: 'There are policies for this client in your records'
  });
};
...
const clientsByName = async (req = request, res = response) => {
  ...
  if (oauthToken) {
    clientsData = await requestApiClient(req, res, '/policies');
  }
